Feature: Syntax API workflow feature
  ...
  @AllJobTitles
  Scenario: Get all employee job titles
    When a Get call is made to get all  the employee job titles
    Then the status code for getting the employees job titles is 200
  ...
  Scenario: Partially Updating the employee
    ...
    Then the status code for this partial updating  is 201